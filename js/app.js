import { Renderer, Camera, Transform, Mesh, Program, Plane, Color } from 'ogl';
document.addEventListener('DOMContentLoaded', function() {
  


const backgroundCanvas = document.createElement('canvas');
backgroundCanvas.id = 'interactive-bg';
...
const renderer = new Renderer({ canvas: backgroundCanvas, dpr: 2 });
...
const program = new Program(gl, {
  ...
  fragment: `
    ...
    uniform float uTime;
    void main() {
      vec3 color = vec3(0.05 + 0.1 * sin(uTime + vUv.xyx * 20.0));
